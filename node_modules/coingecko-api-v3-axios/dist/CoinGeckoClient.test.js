...
describe('CoinGeckoClient test', () => {
    ...
    describe('Coins', () => {
        ...
        it('/coins/market should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.coinMarket({ vs_currency: 'usd', ids: 'origin-protocol,bitcorn' });
    ...
    describe('Simple', () => {
        ...
        it('/simple/prices should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.simplePrice({ vs_currencies: 'eth', ids: 'bitcoin' });
            expect(list).toEqual({
                bitcoin: {
                    eth: expect.any(Number),
                },
    ...
    describe('Contract', () => {
        it('/coins/{id}/contract/{contract_address} should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const aave = yield client.contract({ id: 'ethereum', contract_address: '0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9' });
    ...
    describe('Exchange', () => {
        ...
        it('/exchange/id/status_update should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const aave = yield client.exchangeIdStatusUpdates({ id: 'whitebit' });
        ...
        it('/exchange/id/volume_chart should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const aave = yield client.exchangeIdVolumeChart({ id: 'whitebit', days: 1 });
    ...
    describe('Finance', () => {
        ...
        it('/finance_products should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const products = yield client.financeProducts({});
    ...
    describe('Derivatives', () => {
        ...
        it('/derivatives/exchanges should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.derivativesExchanges({ order: 'name_asc', per_page: 10 });
            expect(list.length).toBeGreaterThan(0);
        }));
        it('/derivatives/exchanges/id should successful', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.derivativesExchangesId({ id: 'bitmex' });
            expect(list).toEqual({
                name: 'BitMEX',
    ...
    describe('Status Updates', () => {
        it('/status_updates', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.statusUpdates();
            expect(list.status_updates.length).toBeGreaterThan(0);
        }));
    });
    describe('Events', () => {
        it('/events', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.events();
            expect(list.data.length).toBeGreaterThanOrEqual(0);
        }));
        it('/events/countries', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.eventsCountries();
        ...
        it('/events/types', () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.eventsTypes();
